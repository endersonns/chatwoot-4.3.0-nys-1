...
import EvolutionApiChannel from '../../api/channel/evolutionApiChannel';
...
export const actions = {
  ...
  createEvolutionInstance: async ({ commit }, params) => {
    try {
      const response = await EvolutionApiChannel.createInstance(params);
      return response.data;
    } catch (error) {
      throw new Error(error?.response?.data?.error || 'Erro ao criar instância Evolution API');
    }
  },
  fetchEvolutionQrCode: async ({ commit }, params) => {
    try {
      const response = await EvolutionApiChannel.fetchQrCode(params.instance_id);
      return response.data;
    } catch (error) {
      throw new Error(error?.response?.data?.error || 'Erro ao buscar QR Code');
    }
  },
  logoutEvolutionInstance: async ({ commit }, params) => {
    try {
      const response = await EvolutionApiChannel.logout(params.instance_id);
      return response.data;
    } catch (error) {
      throw new Error(error?.response?.data?.error || 'Erro ao fazer logout da instância');
    }
  },
  deleteEvolutionInstance: async ({ commit }, params) => {
    try {
      const response = await EvolutionApiChannel.deleteInstance(params.instance_id);
      return response.data;
    } catch (error) {
      throw new Error(error?.response?.data?.error || 'Erro ao deletar instância Evolution API');
    }
  },
