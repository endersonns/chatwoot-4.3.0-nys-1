      ...
      resources :accounts, only: [:create, :show, :update] do
        ...
        scope module: :accounts do
          ...
          namespace :channels do
            ...
            namespace :evolution_api do
              post 'instances', to: 'evolution_api#create_instance'
              get 'instances/:id/qrcode', to: 'evolution_api#qrcode'
              post 'instances/:id/logout', to: 'evolution_api#logout'
              delete 'instances/:id', to: 'evolution_api#destroy'
            end
          end
